...
export namespace UsersSchemas {
  export const getUserDataResponseSchema: JSONSchemaType<UserDataResponseDto> = {
    $id: 'GetUserDataResponseDto',
    type: 'object',
  ...
  export const changePasswordResponseDto: JSONSchemaType<GenericApiResponse> = {
